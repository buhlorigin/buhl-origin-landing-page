  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative overflow-hidden">
        <div className="bg-gradient-to-br from-green-50 to-green-100 min-h-screen flex items-center justify-center px-4">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center mb-20">
            <div className="animate-slide-in-left">
              <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-2xl p-8 h-96 flex items-center justify-center border border-green-200 shadow-lg">
                <div className="text-center">
                  <Coffee className="w-28 h-28 text-green-600 mx-auto mb-6" />
                  ...
                  <p className="text-green-700 font-medium text-lg">Connecting farmers to global markets</p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-6">
              {benefits.map((benefit, index) => (
                <div key={index} className="flex items-center space-x-4 animate-fade-in p-4 rounded-lg hover:bg-green-50 transition-colors" style={{animationDelay: `${index * 0.1}s`}}>
                  <div className="bg-green-100 p-2 rounded-full">
                    <CheckCircle className="w-6 h-6 text-green-600 flex-shrink-0" />
                  </div>
                  <span className="text-xl text-green-700">{benefit}</span>
                </div>
              ))}
            </div>
          </div>
